...
Public Class Shader
    ...
    Public Sub New(vertexSrc As String, fragSrc As String)
        ...
        Dim vertexCode = ExportResource(Assembly.GetExecutingAssembly, "Metaballs", vertexSrc)
        ...
        ' Compile frag shader
        Dim fragCode = ExportResource(Assembly.GetExecutingAssembly, "Metaballs", fragSrc)
